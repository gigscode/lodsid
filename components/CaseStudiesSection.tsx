...
const cases = [
  {
    ...
    before: {
      label: "Before",
      points: [
        "Generic listings page with no clear offer",
        "Visitors browsed but never made contact",
        "Social content had no call to action",
        "No content strategy — just sporadic posts",
      ],
    },
    after: {
      label: "After",
      points: [
        "Dedicated landing page per property type",
        "UGC-style walkthrough videos for each listing",
        "Content strategy aligned to buyer journey",
        "3× more direct inquiries within 30 days",
      ],
    },
    metric: "3× More Inquiries",
    color: "text-[#0d9488]",
    border: "border-[#0d9488]",
  },
  {
    industry: "Landing Page & Content",
    client: "Service Business, Lagos",
    before: {
      label: "Before",
      points: [
        "Generic website with no clear offer",
        "Visitors bounced in under 10 seconds",
        "No lead capture — just a contact email",
        "Social content got likes but zero inquiries",
      ],
    },
    after: {
      label: "After",
      points: [
        "Focused landing page built around one offer",
        "UGC-style video added above the fold",
        "Clear CTA captured leads instantly",
        "Content strategy aligned to the funnel",
      ],
    },
    metric: "4× More Inquiries",
    color: "text-pink-400",
  ...
  },
  {
    ...
    before: {
      label: "Before",
      points: [
        "No landing page — just a general website",
        "Enrollment content had no strategy or CTA",
        "Parents didn't understand the school's value",
        "Admissions season relied on word of mouth only",
      ],
    },
    after: {
      label: "After",
      points: [
        "Dedicated admissions landing page built",
        "UGC-style parent and student testimonial videos",
        "Content calendar for enrollment season",
  ...
  },
  {
    ...
    before: {
      label: "Before",
      points: [
        "No landing page — only a Facebook page",
        "Content posted randomly with no strategy",
        "New patients had no clear way to book",
        "Low trust online despite quality service",
      ],
    },
    after: {
      label: "After",
      points: [
        "Landing page built around key services",
        "UGC-style doctor intro and patient videos",
        "30-day content strategy targeting local audience",
        "60% increase in new patient bookings",
      ],
    },
